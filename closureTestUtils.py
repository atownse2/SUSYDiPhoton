...
fakerateDict = {"Summer16v3" : { "barrel" : (0.016, 0.001),
                                 "endcap" : (0.021, 0.003) }}

def getHistName(sel, hType, ptRange, region = False, bdt = False):
  hName = sel + "_" + hType + "_"
...
varBins = { "pt"    : array("d", np.round(np.linspace(80,300, num = 32), decimals = 3)),
            "eta"   : array("d", np.round(np.linspace(-2.4,2.4, num = 32), decimals = 2)),
